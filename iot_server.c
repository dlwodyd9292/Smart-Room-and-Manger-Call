...
int main(int argc, char *argv[])
{
	...
	CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","KSP_LDP","PASSWD"}, \
			 {0,-1,"","KSP_SMP","PASSWD"},  {0,-1,"","KSP_LIN","PASSWD"}, \
			 {0,-1,"","KSP_ARD1","PASSWD"},  {0,-1,"","LJY_LDP","PASSWD"}, \
			 {0,-1,"","LJY_SMP","PASSWD"},  {0,-1,"","LJY_LIN","PASSWD"}, \
			 {0,-1,"","LJY_ARD","PASSWD"},  {0,-1,"","KYJ_LDP","PASSWD"}, \
			 {0,-1,"","KYJ_SMP","PASSWD"},  {0,-1,"","KYJ_LIN","PASSWD"}, \
			 {0,-1,"","KYJ_ARD","PASSWD"},  {0,-1,"","LJY_ARD1","PASSWD"}, \
			 {0,-1,"","KSP_ARD2","PASSWD"},  {0,-1,"","15","PASSWD"}, \
